...
/**
 * 类的作用:    向Web站点发送GET请求、POST请求，并从Web站点取得响应
 * Description:
...
public class GetPostTest {
     ...
     * 向指定URL发送GET方式的请求
     * @param       url         发送请求的URL
     * @param       param       请求参数，格式满足 name1 = value1 & name2 = value2 的形式
     * @return:     URL代表远程资源的响应
     */
    public static String sendGet(String url, String param)
    {
        ...
        try
        {
            ...
            conn.setRequestProperty("user-agent",
                    "Mozilla/4.0/ (compatible; MISE 6.0; Windows NT 5.1; SV1)");
            //建立实际的连接
            conn.connect();
            //获取所有的响应头字段
    ...
    public static void main(String[] args)
    {
        ...
        //发送POST请求
        String s1 = GetPostTest.sendPost("http://localhost:8888/abc/login.jsp", null);
