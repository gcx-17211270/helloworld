 ...
 * 类           ServerThread2
 * 类的作用:    服务器端线程类
 * Description: 因为本线程类要分别处理公聊、私聊两类聊天信息，除此之外，还要解决用户名是否重复，因而
 *          程序会复杂一些。
 * @param
 * @return:
    ...
    public void run()
    {
        try
        {
            ...
            while ((line = br.readLine()) != null)
            {
                ...
                /****************************关键代码end0***************************/
                //CrazyitProtocol.PRIVATE_ROUND开始，并以其结束
                //可以确定是私聊信息
                ...
                else
                {
                    ...
                    //遍历clients中的每个输出流
                    for (var clientsPS : Server.clients.valueSet())
                    {
        ...
        //捕获到异常之后，表明该Socket对应的客户端已经出现了问题
        //所以程序将其对应的输出流从Map中删除
        catch (IOException e)
        {
